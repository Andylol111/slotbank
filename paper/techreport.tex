...
\centering
\resizebox{\linewidth}{!}{%
\IfFileExists{figures/qwen27b_three_category_body.tex}{%
  \input{figures/qwen27b_three_category_body.tex}%
}{\IfFileExists{../eval/figures/qwen27b_three_category_body.tex}{%
  \input{../eval/figures/qwen27b_three_category_body.tex}%
}{\IfFileExists{eval/figures/qwen27b_three_category_body.tex}{%
  \input{eval/figures/qwen27b_three_category_body.tex}%
}{\errmessage{Missing figures/qwen27b_three_category_body.tex. Place that file next to main.tex (Overleaf: upload the figures/ folder).}}}}%
}
